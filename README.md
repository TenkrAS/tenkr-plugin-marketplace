...
| **knowledge-vault** | 0.4.0 | Per-project knowledge search for Claude Code — indexes your session transcripts, project memory, and your own documents into a local hybrid (vector + keyword) index, then answers natural-language questions with citations. Optional OCR for PDFs, Office docs, and images. |
